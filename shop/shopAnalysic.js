...
let sql = 'select addresses.email, addresses.country as shippingCountry,' +
          'orders.user_id, customer_roles.name, users.user_name, '+
          ...
          'left join customer_roles on customer_roles.id = orders.user_id ' +
...
let sqlTotalSales = 'select sum(line_items.qty) as totalSale from line_items ' +
                    ...
                    'addresses.addressable_type = \'Order\'';
